...
def one_click_test(config, model_zoo):
    ...
    for _, value in config['enviroments'].items():
        cmd = ddp_meta_command.format(value, args.model)
    ...
    cmd = ddp_graph_command.format(args.model, args.model)
    os.system(cmd)
...
if __name__ == '__main__':
    ...
    one_click_test(config, model_zoo)
